...
class PodcastPlayerVC: UIViewController {
    ...
    func configure() {
        // set up player
        let podcast = podcast[position]
        
        let urlString = Bundle.main.path(forResource: podcast.trackName, ofType: "mp3")
        ...
        albumImageView.image = UIImage(named: podcast.imageName)
        ...
        albumNameLabel.frame = CGRect(x: 10,
                                      y: albumImageView.frame.size.height + 20 + 80,
                                      width: holder.frame.size.width-20,
                                      height: 70)
        artistNameLabel.frame = CGRect(x: 10,
                                       y: albumImageView.frame.size.height + 20 + 140,
                                       width: holder.frame.size.width-20,
                                       height: 70)
        
        songNameLabel.text = podcast.name
        albumNameLabel.text = podcast.albumName
